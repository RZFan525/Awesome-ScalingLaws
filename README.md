...
2. **One Epoch Is All You Need**

   *Aran Komatsuzaki* [[paper]](https://arxiv.org/abs/1906.06669) Arxiv 2019.06
   
3. **A Constructive Prediction of the Generalization Error Across Scales**

   *Jonathan S. Rosenfeld, Amir Rosenfeld, Yonatan Belinkov, Nir Shavit* [[paper]](https://arxiv.org/abs/1909.12673) ICLR2020 2019.09
...
5. **Train Large, Then Compress: Rethinking Model Size for Efficient Training and Inference of Transformers**
   ...
   *Zhuohan Li, Eric Wallace, Sheng Shen, Kevin Lin, Kurt Keutzer, Dan Klein, Joseph E. Gonzalez* [[paper]](https://arxiv.org/abs/2002.11794) ICML2020 2020.02

6. **Recipes for building an open-domain chatbot**

   *Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu, Jing Xu, Myle Ott, Kurt Shuster, Eric M. Smith, Y-Lan Boureau, Jason Weston* [[paper]](https://arxiv.org/abs/2004.13637) EACL2021 2020.04

7. **On the Predictability of Pruning Across Scales**

   *Jonathan S. Rosenfeld, Jonathan Frankle, Michael Carbin, Nir Shavit* [[paper]](https://arxiv.org/abs/2006.10621) ICML2021 2020.06
   
8. **The Computational Limits of Deep Learning**
...
15. **A Scaling Law for Synthetic-to-Real Transfer: How Much Is Your Pre-training Effective?**
...
16. **Scaling Laws for Neural Machine Translation**
...
17. **Scaling Laws for the Few-Shot Adaptation of Pre-trained Image Classifiers**  
    
    *Gabriele Prato, Simon Guiroy, Ethan Caballero, Irina Rish, Sarath Chandar* [[paper]](https://arxiv.org/abs/2110.06990) Arxiv 2021.10

18. **Scaling Law for Recommendation Models: Towards General-purpose User Representations**
...
19. **Unified Scaling Laws for Routed Language Models**
...
20. **Data Scaling Laws in NMT: The Effect of Noise and Architecture**
...
21. **Scaling Laws Under the Microscope: Predicting Transformer Performance from Small Scale Experiments**
...
23. **Scaling Laws and Interpretability of Learning from Repeated Data**
...
24. **Beyond neural scaling laws: beating power law scaling via data pruning**
...
25. **Scaling Laws vs Model Architectures: How does Inductive Bias Influence Scaling?**
...
26. **Understanding Scaling Laws for Recommendation Models**
...
31. **Scaling Laws for Reward Model Overoptimization**

    *Leo Gao, John Schulman, Jacob Hilton* [[paper]](https://arxiv.org/abs/2210.10760) Arxiv 2022.10
 
32. **Transcending Scaling Laws with 0.1% Extra Compute**
...
33. **Scaling Laws Beyond Backpropagation**
...
39. **Scaling Laws for Generative Mixed-Modal Language Models**
...
40. **Scaling laws for single-agent reinforcement learning**

    *Jacob Hilton, Jie Tang, John Schulman* [[paper]](https://arxiv.org/abs/2301.13442) Arxiv 2023.01
    
41. **Data pruning and neural scaling laws: fundamental limitations of score-based algorithms**
  
    *Fadhel Ayed, Soufiane Hayou* [[paper]](https://arxiv.org/abs/2302.06960) Arxiv 2023.02
 
42. **Scaling Laws for Multilingual Neural Machine Translation**
